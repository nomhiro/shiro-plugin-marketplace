...
| [stop-ai-slop-jp](plugins/stop-ai-slop-jp/) | AIで書いた日本語から、AI臭さを取り除くスキル（[iKora128/stop-ai-slop-jp](https://github.com/iKora128/stop-ai-slop-jp) を取り込んだもの、MIT）。講義名や台本を外に出す前に通す |
